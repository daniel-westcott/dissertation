...
regreencut_blastp_eVal-100 = biogenic-e-100 ~ non-photosynthetic
#A venn of all photosynthetic genes overlapping with the bg set you need to add a full At blast set here.
venn_ps_blastp_eVal-100 = venndiagram [bg-cre-olap-e-100,bg-aux-olap-e-100,bg-at-olap-e-100,bg-ids]
#A venn of non-photosynthetic genes overlapping with the bg-set
venn_non_ps_blastp_eVal-100 = venndiagram [bg-scer-olap-e-100, bg-ecol-olap-e-100, bg-mel-olap-e-100, bg-ids]
#A broad level venn diagram showing the original set, non-ps set, photosynthetic, and biogenic
venn_all_1way_blastp_eVal-100 = venndiagram [non-ps-ids, ps-bht-ids,bg-at-olap-e-100,bg-arc-olap-e-100,bg-ids]
#rgc venn
venn_rgc_1way_blastp_eVal-100 = venndiagram [non-ps-ids,bg-at-olap-e-100,bg-arc-olap-e-100,bg-ids]

tabl_1way_blastp_e-100 = sets_table [bg-ids,
