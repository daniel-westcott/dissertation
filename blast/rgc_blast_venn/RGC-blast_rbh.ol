...
venn_ps_blast_rbh = venndiagram [rbh-bg-cre-olap,rbh-bg-aux-olap,rbh-bg-ath-olap,rbh-bg-ids]
...
#rgc venn
venn_rgc_1way_blastp_eVal-100 = venndiagram [non-ps-ids,rbh-bg-at-olap,rbh-bg-arc-olap,rbh-bg-ids]
