...
regreencut_diamond_blastp_eVal-200 = biogenic-e-200 ~ non-photosynthetic
#A venn of all photosynthetic genes overlapping with the bg set you need to add a full At diamond set here.
venn_ps_diamond_blastp_eVal-200 = venndiagram [bg-cre-olap-e-200,bg-aux-olap-e-200,bg-ath-olap-e-200,bg-ids]
#A venn of non-photosynthetic genes overlapping with the bg-set
venn_non_ps_diamond_blastp_eVal-200 = venndiagram [bg-scer-olap-e-200, bg-ecol-olap-e-200, bg-mel-olap-e-200, bg-ids]
#A broad level venn diagram showing the original set, non-ps set, photosynthetic, and biogenic
venn_all_1way_diamond_blastp_eVal-200 = venndiagram [non-ps-ids, ps-bht-ids,bg-at-olap-e-200,bg-arc-olap-e-200,bg-ids]
#rgc venn
venn_rgc_1way_diamond_blastp_eVal-200 = venndiagram [non-ps-ids,bg-at-olap-e-200,bg-arc-olap-e-200,bg-ids]

tabl_1way_diamond_blastp_e-200 = sets_table [bg-ids,
...
result = tabl_1way_diamond_blastp_e-200
