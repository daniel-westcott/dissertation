...
#reciprocal diamond searches F = A to B and R = B to A
e_col-degsF = diamond_blastp 1.0e-5 e_coli bg_degs
e_col-degsR = diamond_blastp 1.0e-5 bg_degs e_coli
s_cer-degsF = diamond_blastp 1.0e-5 S_cer bg_degs
s_cer-degsR = diamond_blastp 1.0e-5 bg_degs S_cer
mel-degsF = diamond_blastp 1.0e-5 mel_aa bg_degs
mel-degsR = diamond_blastp 1.0e-5 bg_degs mel_aa
atgerm-degs-diamondF = diamond_blastp 1.0e-5 at_germ bg_degs
atgerm-degs-diamondR = diamond_blastp 1.0e-5 bg_degs at_germ
aux-degs-diamondF = diamond_blastp 1.0e-5 aux_aa bg_degs
aux-degs-diamondR = diamond_blastp 1.0e-5 bg_degs aux_aa
cre-degs-diamondF = diamond_blastp 1.0e-5 cre_aa bg_degs
cre-degs-diamondR = diamond_blastp 1.0e-5 bg_degs cre_aa
arc_seq-degs-diamondF = diamond_blastp 1.0e-5 arc_seq_aa bg_degs
arc_seq-degs-diamondR = diamond_blastp 1.0e-5 bg_degs arc_seq_aa
ath-degs-diamondF = diamond_blastp 1.0e-5 bg_degs athal_aa
ath-degs-diamondR = diamond_blastp 1.0e-5 athal_aa bg_degs
...
atgerm-degs-diamond = reciprocal_best atgerm-degs-diamondF atgerm-degs-diamondR
aux-degs-diamond = reciprocal_best aux-degs-diamondF aux-degs-diamondR
cre-degs-diamond = reciprocal_best cre-degs-diamondF cre-degs-diamondR
arc-degs-diamond = reciprocal_best arc_seq-degs-diamondF arc_seq-degs-diamondR
ath-degs-diamond = reciprocal_best ath-degs-diamondF ath-degs-diamondR

#Create BHTs of organism sets
non-ps-bht = concat_bht [e_col-degs, mel-degs, s_cer-degs]
ps-bht = concat_bht [aux-degs-diamond, cre-degs-diamond,ath-degs-diamond]
biogenic-bht = concat_bht [atgerm-degs-diamond,arc-degs-diamond]

#Extract IDs for comparisons
rbh-bg-at-olap = extract_targets atgerm-degs-diamond
rbh-bg-aux-olap = extract_targets aux-degs-diamond
rbh-bg-cre-olap = extract_targets cre-degs-diamond
...
rbh-bg-arc-olap = extract_targets arc-degs-diamond
rbh-bg-ath-olap = extract_queries ath-degs-diamond
...
regreencut_diamond_rbh = rbh-biogenic ~ non-photosynthetic
#A venn of all photosynthetic genes overlapping with the bg set you need to add a full At diamond set here.
venn_ps_diamond_rbh = venndiagram [rbh-bg-cre-olap,rbh-bg-aux-olap,rbh-bg-ath-olap,rbh-bg-ids]
#A venn of non-photosynthetic genes overlapping with the rbh-bg-set
venn_non_ps_diamond_rbh = venndiagram [rbh-bg-scer-olap, rbh-bg-ecol-olap, rbh-bg-mel-olap, rbh-bg-ids]
#A broad level venn diagram showing the original set, non-ps set, photosynthetic, and biogenic
venn_all_diamond_rbh = venndiagram [non-ps-ids, ps-bht-ids,rbh-bg-at-olap,rbh-bg-arc-olap, rbh-bg-ids]
#The final venn that I want 
venn_rgc_rbh venndiagram [non-ps-ids, rbh-bg-at-olap, rbh-bg-arc-olap, rbh-bg-ids]

tabl_diamond_rbh = sets_table [rbh-bg-ids,
