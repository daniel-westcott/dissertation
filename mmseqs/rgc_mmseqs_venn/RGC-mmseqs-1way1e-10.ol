...
#Increase stringency 
atgerm-degs-strict = filter_evalue 1.0e-10 atgerm-degs
aux-degs-strict = filter_evalue 1.0e-10 aux-degs
e_col-degs-strict = filter_evalue 1.0e-10 e_col-degs
s_cer-degs-strict = filter_evalue 1.0e-10 s_cer-degs
mel-degs-strict = filter_evalue 1.0e-10 mel-degs
arc-degs-strict = filter_evalue 1.0e-10 arc_seq-degs
cre-degs-strict = filter_evalue 1.0e-10 cre-degs
ath-degs-strict = filter_evalue 1.0e-10 ath-degs
...
bg-at-olap-e-10 = extract_queries atgerm-degs-strict
bg-aux-olap-e-10 = extract_queries aux-degs-strict
bg-cre-olap-e-10 = extract_queries cre-degs-strict
bg-scer-olap-e-10 = extract_queries s_cer-degs-strict
bg-ecol-olap-e-10 = extract_queries e_col-degs-strict
bg-mel-olap-e-10 = extract_queries mel-degs-strict
bg-arc-olap-e-10 = extract_queries arc-degs-strict
bg-ath-olap-e-10 = extract_queries ath-degs-strict
...
non-photosynthetic = bg-scer-olap-e-10 | bg-ecol-olap-e-10 | bg-mel-olap-e-10
#This is the set of all genes that have high homology to the Cz bg-ids set
all_lap = bg-at-olap-e-10 | bg-aux-olap-e-10 | bg-cre-olap-e-10 | non-photosynthetic | bg-arc-olap-e-10
#These are the genes that don't match anything
nolap-e-10 = bg-ids ~ all_lap
# biogenic is arc-seq and at_germ together
biogenic-e-10 = bg-at-olap-e-10 | bg-arc-olap-e-10
#regreencut is the overlapping genes with the non-photosynthetic subracted. 
regreencut_mmseqs_search_eVal-10 = biogenic-e-10 ~ non-photosynthetic
#A venn of all photosynthetic genes overlapping with the bg set you need to add a full At mmseqs set here.
venn_ps_mmseqs_search_eVal-10 = venndiagram [bg-cre-olap-e-10,bg-aux-olap-e-10,bg-ath-olap-e-10,bg-ids]
#A venn of non-photosynthetic genes overlapping with the bg-set
venn_non_ps_mmseqs_search_eVal-10 = venndiagram [bg-scer-olap-e-10, bg-ecol-olap-e-10, bg-mel-olap-e-10, bg-ids]
#A broad level venn diagram showing the original set, non-ps set, photosynthetic, and biogenic
venn_all_1way_mmseqs_search_eVal-10 = venndiagram [non-ps-ids, ps-bht-ids,bg-at-olap-e-10,bg-arc-olap-e-10,bg-ids]
#rgc venn
venn_rgc_1way_mmseqs_search_eVal-10 = venndiagram [non-ps-ids,bg-at-olap-e-10,bg-arc-olap-e-10,bg-ids]


tabl_1way_mmseqs_search_e-10 = sets_table [bg-ids,
                   bg-at-olap-e-10,bg-arc-olap-e-10,
                   bg-aux-olap-e-10,
                   bg-cre-olap-e-10,
                   bg-scer-olap-e-10,
                   bg-ecol-olap-e-10,
                   bg-mel-olap-e-10,bg-ath-olap-e-10]
result = tabl_1way_mmseqs_search_e-10
