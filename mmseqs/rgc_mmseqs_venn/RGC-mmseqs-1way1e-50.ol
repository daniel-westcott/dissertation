...
#Increase stringency 
atgerm-degs-strict = filter_evalue 1.0e-50 atgerm-degs
aux-degs-strict = filter_evalue 1.0e-50 aux-degs
e_col-degs-strict = filter_evalue 1.0e-50 e_col-degs
s_cer-degs-strict = filter_evalue 1.0e-50 s_cer-degs
mel-degs-strict = filter_evalue 1.0e-50 mel-degs
arc-degs-strict = filter_evalue 1.0e-50 arc_seq-degs
cre-degs-strict = filter_evalue 1.0e-50 cre-degs
ath-degs-strict = filter_evalue 1.0e-50 ath-degs
...
bg-at-olap-e-50 = extract_queries atgerm-degs-strict
bg-aux-olap-e-50 = extract_queries aux-degs-strict
bg-cre-olap-e-50 = extract_queries cre-degs-strict
bg-scer-olap-e-50 = extract_queries s_cer-degs-strict
bg-ecol-olap-e-50 = extract_queries e_col-degs-strict
bg-mel-olap-e-50 = extract_queries mel-degs-strict
bg-arc-olap-e-50 = extract_queries arc-degs-strict
bg-ath-olap-e-50 = extract_queries ath-degs-strict
...
non-photosynthetic = bg-scer-olap-e-50 | bg-ecol-olap-e-50 | bg-mel-olap-e-50
#This is the set of all genes that have high homology to the Cz bg-ids set
all_lap = bg-at-olap-e-50 | bg-aux-olap-e-50 | bg-cre-olap-e-50 | non-photosynthetic | bg-arc-olap-e-50
#These are the genes that don't match anything
nolap-e-50 = bg-ids ~ all_lap
# biogenic is arc-seq and at_germ together
biogenic-e-50 = bg-at-olap-e-50 | bg-arc-olap-e-50
#regreencut is the overlapping genes with the non-photosynthetic subracted. 
regreencut_mmseqs_search_eVal-50 = biogenic-e-50 ~ non-photosynthetic
#A venn of all photosynthetic genes overlapping with the bg set you need to add a full At mmseqs set here.
venn_ps_mmseqs_search_eVal-50 = venndiagram [bg-cre-olap-e-50,bg-aux-olap-e-50,bg-ath-olap-e-50,bg-ids]
#A venn of non-photosynthetic genes overlapping with the bg-set
venn_non_ps_mmseqs_search_eVal-50 = venndiagram [bg-scer-olap-e-50, bg-ecol-olap-e-50, bg-mel-olap-e-50, bg-ids]
#A broad level venn diagram showing the original set, non-ps set, photosynthetic, and biogenic
venn_all_1way_mmseqs_search_eVal-50 = venndiagram [non-ps-ids, ps-bht-ids,bg-at-olap-e-50,bg-arc-olap-e-50,bg-ids]
#rgc venn
venn_rgc_1way_mmseqs_search_eVal-50 = venndiagram [non-ps-ids,bg-at-olap-e-50,bg-arc-olap-e-50,bg-ids]

tabl_1way_mmseqs_search_e-50 = sets_table [bg-ids,
                   bg-at-olap-e-50,bg-arc-olap-e-50,
                   bg-aux-olap-e-50,
                   bg-cre-olap-e-50,
                   bg-scer-olap-e-50,
                   bg-ecol-olap-e-50,
                   bg-mel-olap-e-50,bg-ath-olap-e-50]
result = tabl_1way_mmseqs_search_e-50
