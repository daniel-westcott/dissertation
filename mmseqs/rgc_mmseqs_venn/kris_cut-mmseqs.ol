...
#kris kut
kris_kut_mmseqs = bg-ids ~ non-ps-ids
...
vennKris_kut_mmseqs = venndiagram [bg-ids,e_col-degs-ids,s_cer-degs-ids,mel-degs-ids]

tabl_1way_mmseqs_kris_cut = sets_table [bg-ids,
                   e_col-degs-ids,
                   s_cer-degs-ids,
                   mel-degs-ids]
result = tabl_1way_mmseqs_kris_cut
