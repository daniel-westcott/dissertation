...
regreencut_mmseqs_search_eVal-20 = biogenic-e-20 ~ non-photosynthetic
#A venn of all photosynthetic genes overlapping with the bg set you need to add a full At mmseqs set here.
venn_ps_mmseqs_search_eVal-20 = venndiagram [bg-cre-olap-e-20,bg-aux-olap-e-20,bg-ath-olap-e-20,bg-ids]
#A venn of non-photosynthetic genes overlapping with the bg-set
venn_non_ps_mmseqs_search_eVal-20 = venndiagram [bg-scer-olap-e-20, bg-ecol-olap-e-20, bg-mel-olap-e-20, bg-ids]
#A broad level venn diagram showing the original set, non-ps set, photosynthetic, and biogenic
venn_all_1way_mmseqs_search_eVal-20 = venndiagram [non-ps-ids, ps-bht-ids,bg-at-olap-e-20,bg-arc-olap-e-20,bg-ids]
#rgc venn
venn_rgc_1way_mmseqs_search_eVal-20 = venndiagram [non-ps-ids,bg-at-olap-e-20,bg-arc-olap-e-20,bg-ids]

tabl_1way_mmseqs_search_e-20 = sets_table [bg-ids,
...
result = tabl_1way_mmseqs_search_e-20
