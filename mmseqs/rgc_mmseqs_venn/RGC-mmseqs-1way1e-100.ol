...
#Increase stringency 
atgerm-degs-strict = filter_evalue 1.0e-100 atgerm-degs
aux-degs-strict = filter_evalue 1.0e-100 aux-degs
e_col-degs-strict = filter_evalue 1.0e-100 e_col-degs
s_cer-degs-strict = filter_evalue 1.0e-100 s_cer-degs
mel-degs-strict = filter_evalue 1.0e-100 mel-degs
arc-degs-strict = filter_evalue 1.0e-100 arc_seq-degs
cre-degs-strict = filter_evalue 1.0e-100 cre-degs
ath-degs-strict = filter_evalue 1.0e-100 ath-degs
...
bg-at-olap-e-100 = extract_queries atgerm-degs-strict
bg-aux-olap-e-100 = extract_queries aux-degs-strict
bg-cre-olap-e-100 = extract_queries cre-degs-strict
bg-scer-olap-e-100 = extract_queries s_cer-degs-strict
bg-ecol-olap-e-100 = extract_queries e_col-degs-strict
bg-mel-olap-e-100 = extract_queries mel-degs-strict
bg-arc-olap-e-100 = extract_queries arc-degs-strict
bg-ath-olap-e-100 = extract_queries ath-degs-strict
...
non-photosynthetic = bg-scer-olap-e-100 | bg-ecol-olap-e-100 | bg-mel-olap-e-100
#This is the set of all genes that have high homology to the Cz bg-ids set
all_lap = bg-at-olap-e-100 | bg-aux-olap-e-100 | bg-cre-olap-e-100 | non-photosynthetic | bg-arc-olap-e-100
#These are the genes that don't match anything
nolap-e-100 = bg-ids ~ all_lap
# biogenic is arc-seq and at_germ together
biogenic-e-100 = bg-at-olap-e-100 | bg-arc-olap-e-100
#regreencut is the overlapping genes with the non-photosynthetic subracted. 
regreencut_mmseqs_search_eVal-100 = biogenic-e-100 ~ non-photosynthetic
#A venn of all photosynthetic genes overlapping with the bg set you need to add a full At mmseqs set here.
venn_ps_mmseqs_search_eVal-100 = venndiagram [bg-cre-olap-e-100,bg-aux-olap-e-100,bg-ath-olap-e-100,bg-ids]
#A venn of non-photosynthetic genes overlapping with the bg-set
venn_non_ps_mmseqs_search_eVal-100 = venndiagram [bg-scer-olap-e-100, bg-ecol-olap-e-100, bg-mel-olap-e-100, bg-ids]
#A broad level venn diagram showing the original set, non-ps set, photosynthetic, and biogenic
venn_all_1way_mmseqs_search_eVal-100 = venndiagram [non-ps-ids, ps-bht-ids,bg-at-olap-e-100,bg-arc-olap-e-100,bg-ids]
#rgc venn
venn_rgc_1way_mmseqs_search_eVal-100 = venndiagram [non-ps-ids,bg-at-olap-e-100,bg-arc-olap-e-100,bg-ids]

tabl_1way_mmseqs_search_e-100 = sets_table [bg-ids,
                   bg-at-olap-e-100,bg-arc-olap-e-100,
                   bg-aux-olap-e-100,
                   bg-cre-olap-e-100,
                   bg-scer-olap-e-100,
                   bg-ecol-olap-e-100,
                   bg-mel-olap-e-100,bg-ath-olap-e-100]
result = tabl_1way_mmseqs_search_e-100
