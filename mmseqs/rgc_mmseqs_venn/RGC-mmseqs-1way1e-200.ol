...
#Permissive 1 way mmseqs searches.
e_col-degs = mmseqs_search 1.0e-5 bg_degs e_coli
s_cer-degs = mmseqs_search 1.0e-5 bg_degs S_cer
mel-degs = mmseqs_search 1.0e-5 bg_degs mel_aa
atgerm-degs = mmseqs_search 1.0e-5 bg_degs at_germ
aux-degs = mmseqs_search 1.0e-5 bg_degs aux_aa
cre-degs = mmseqs_search 1.0e-5 bg_degs cre_aa
arc_seq-degs = mmseqs_search 1.0e-5 bg_degs arc_seq_aa
arc-cre-degs = mmseqs_search 1.0e-5 arc_seq_aa cre_aa
ath-degs = mmseqs_search 1.0e-5 bg_degs athal_aa

#Increase stringency 
atgerm-degs-strict = filter_evalue 1.0e-200 atgerm-degs
aux-degs-strict = filter_evalue 1.0e-200 aux-degs
e_col-degs-strict = filter_evalue 1.0e-200 e_col-degs
s_cer-degs-strict = filter_evalue 1.0e-200 s_cer-degs
mel-degs-strict = filter_evalue 1.0e-200 mel-degs
arc-degs-strict = filter_evalue 1.0e-200 arc_seq-degs
cre-degs-strict = filter_evalue 1.0e-200 cre-degs
ath-degs-strict = filter_evalue 1.0e-200 ath-degs
...
bg-at-olap-e-200 = extract_queries atgerm-degs-strict
bg-aux-olap-e-200 = extract_queries aux-degs-strict
bg-cre-olap-e-200 = extract_queries cre-degs-strict
bg-scer-olap-e-200 = extract_queries s_cer-degs-strict
bg-ecol-olap-e-200 = extract_queries e_col-degs-strict
bg-mel-olap-e-200 = extract_queries mel-degs-strict
bg-arc-olap-e-200 = extract_queries arc-degs-strict
bg-ath-olap-e-200 = extract_queries ath-degs-strict
...
non-photosynthetic = bg-scer-olap-e-200 | bg-ecol-olap-e-200 | bg-mel-olap-e-200
#This is the set of all genes that have high homology to the Cz bg-ids set
all_lap = bg-at-olap-e-200 | bg-aux-olap-e-200 | bg-cre-olap-e-200 | non-photosynthetic | bg-arc-olap-e-200
#These are the genes that don't match anything
nolap-e-200 = bg-ids ~ all_lap
# biogenic is arc-seq and at_germ together
biogenic-e-200 = bg-at-olap-e-200 | bg-arc-olap-e-200
#regreencut is the overlapping genes with the non-photosynthetic subracted. 
regreencut_mmseqs_search_eVal-200 = biogenic-e-200 ~ non-photosynthetic
#A venn of all photosynthetic genes overlapping with the bg set you need to add a full At mmseqs set here.
venn_ps_mmseqs_search_eVal-200 = venndiagram [bg-cre-olap-e-200,bg-aux-olap-e-200,bg-ath-olap-e-200,bg-ids]
#A venn of non-photosynthetic genes overlapping with the bg-set
venn_non_ps_mmseqs_search_eVal-200 = venndiagram [bg-scer-olap-e-200, bg-ecol-olap-e-200, bg-mel-olap-e-200, bg-ids]
#A broad level venn diagram showing the original set, non-ps set, photosynthetic, and biogenic
venn_all_1way_mmseqs_search_eVal-200 = venndiagram [non-ps-ids, ps-bht-ids,bg-at-olap-e-200,bg-arc-olap-e-200,bg-ids]
#rgc venn
venn_rgc_1way_mmseqs_search_eVal-200 = venndiagram [non-ps-ids,bg-at-olap-e-200,bg-arc-olap-e-200,bg-ids]

tabl_1way_mmseqs_search_e-200 = sets_table [bg-ids,
                   bg-at-olap-e-200,bg-arc-olap-e-200,
                   bg-aux-olap-e-200,
                   bg-cre-olap-e-200,
                   bg-scer-olap-e-200,
                   bg-ecol-olap-e-200,
                   bg-mel-olap-e-200,bg-ath-olap-e-200]
result = tabl_1way_mmseqs_search_e-200
